...
public class TestEntity extends GolemEntity implements IAngerable {
   protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.createKey(TestEntity.class, DataSerializers.BYTE);
   ...
   public TestEntity(EntityType<? extends TestEntity> type, World worldIn) {
      super(type, worldIn);
   ...
   public boolean attackEntityFrom(DamageSource source, float amount) {
      TestEntity.Cracks irongolementity$cracks = this.func_226512_l_();
   ...
   public TestEntity.Cracks func_226512_l_() {
      return TestEntity.Cracks.func_226515_a_(this.getHealth() / this.getMaxHealth());
   }
   ...
   public static enum Cracks {
      ...
      private static final List<TestEntity.Cracks> field_226513_e_ = Stream.of(values()).sorted(Comparator.comparingDouble((p_226516_0_) -> {
      ...
      public static TestEntity.Cracks func_226515_a_(float p_226515_0_) {
         for(TestEntity.Cracks irongolementity$cracks : field_226513_e_) {
