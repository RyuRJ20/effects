...
public class NuibariEntity extends AbstractArrowEntity {
   private static final DataParameter<Byte> LOYALTY_LEVEL = EntityDataManager.createKey(NuibariEntity.class, DataSerializers.BYTE);
   private static final DataParameter<Boolean> field_226571_aq_ = EntityDataManager.createKey(NuibariEntity.class, DataSerializers.BOOLEAN);
   private ItemStack thrownStack = new ItemStack(Items.NUIBARI.get());
   private boolean dealtDamage;
   public int returningTicks;

   public NuibariEntity(EntityType<? extends NuibariEntity> type, World worldIn) {
      super(type, worldIn);
   }

   public NuibariEntity(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
   ...
   @OnlyIn(Dist.CLIENT)
   public NuibariEntity(World worldIn, double x, double y, double z) {
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("Nuibari", 10)) {
         this.thrownStack = ItemStack.read(compound.getCompound("Nuibari"));
      }
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      compound.put("Nuibari", this.thrownStack.write(new CompoundNBT()));
